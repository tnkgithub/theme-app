  ...
  return (
    <main>
      <div className='m-2 grid grid-cols-26 gap-1'>
        ...
        <div className='bg-blue-400'>2nd col</div>
        <div className='bg-blue-400'>3rd col</div>
        <div className='bg-blue-400'>4th col</div>
        <div className='bg-blue-400'>5th col</div>
        <div className='bg-blue-400'>6th col</div>
        <div className='bg-blue-400'>7th col</div>
        <div className='bg-blue-400'>8th col</div>
        <div className='bg-blue-400'>9th col</div>
        <div className='bg-blue-900'>10th col</div>
        <div className='bg-blue-400'>1st col</div>
        <div className='bg-blue-400'>2nd col</div>
        <div className='bg-blue-400'>3rd col</div>
        <div className='bg-blue-400'>4th col</div>
        <div className='bg-blue-400'>5th col</div>
