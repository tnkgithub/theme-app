...
const FullSideBar = ({
  ...
  return (
    <>
      <div className='h-dynamic fixed top-11 z-10 w-56 border-r border-gray-300 bg-white md:top-28 lg:top-16'>
      ...
      <div className='h-dynamic w-8 md:w-56' />
    </>
  );
};
...
const SmallSideBar = ({ handleSidebar }: { handleSidebar: () => void }) => {
  return (
    <>
      <div className='h-dynamic fixed top-11 z-10 w-12 border-r border-gray-300 bg-white md:top-28 lg:top-16'>
