...
const FullSideBar = ({
  ...
  return (
    <>
      <div className='fixed top-11 z-10 h-dynamic w-56 border-r border-gray-300 bg-white md:top-28 lg:top-16'>
...
const SmallSideBar = ({ handleSidebar }: { handleSidebar: () => void }) => {
  return (
    <>
      <div className='fixed top-11 z-10 h-dynamic w-12 border-r border-gray-300 bg-white md:top-28 lg:top-16'>
